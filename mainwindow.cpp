...
ULONG        Position_voulue_M3X_Handle;
ULONG        Position_voulue_M3Y_Handle;
...
double      Position_voulue_M3X_Value;
double      Position_voulue_M3Y_Value;
...
void MainWindow::on_CMD_MOTEUR_clicked()
{
    ...
    QString Angle_Poloidal_Voulu_2;
    QString Angle_Toroidal_Voulu_2;

    Angle_Poloidal_Voulu = ui->Angle_Poloidal->toPlainText();
    Angle_Toroidal_Voulu = ui->Angle_Toroidal->toPlainText();
    Angle_Poloidal_Voulu_2 = ui->Angle_Poloidal_2->toPlainText();
    Angle_Toroidal_Voulu_2 = ui->Angle_Toroidal_2->toPlainText();
    ...
    Position_voulue_M2X_Value = Angle_Poloidal_Voulu_2.toDouble();
    Position_voulue_M2Y_Value = Angle_Toroidal_Voulu_2.toDouble();
    ...
    nError = AdsSyncWriteReq(pAddr, ADSIGRP_SYM_VALBYHND, Position_voulue_M1Y_Handle, sizeof(Position_voulue_M1Y_Value), &Position_voulue_M1Y_Value);
      if (nError) cerr << "Error: AdsSyncWriteReq: " << nError << '\n';
    nError = AdsSyncWriteReq(pAddr, ADSIGRP_SYM_VALBYHND, Position_voulue_M2X_Handle, sizeof(Position_voulue_M2X_Value), &Position_voulue_M2X_Value);
      if (nError) cerr << "Error: AdsSyncWriteReq: " << nError << '\n';
    nError = AdsSyncWriteReq(pAddr, ADSIGRP_SYM_VALBYHND, Position_voulue_M2Y_Handle, sizeof(Position_voulue_M2Y_Value), &Position_voulue_M2Y_Value);
      if (nError) cerr << "Error: AdsSyncWriteReq: " << nError << '\n';
    // Do for all Motors
